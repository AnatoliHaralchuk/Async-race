  ...
  public drawCar(car: Car): string {
    return `
        <div class="sub-set-control">
            ...
            <button class="remove-car btn" data-remove = "${
              car.id
            }">remove</button>
            <span class="name-car">${car.name}</span>
        </div>
        <div class="road">
            <button class="start-engine btn-engine" data-start = "${
              car.id
            }">A</button>
            <button class="stop-engine btn-engine" data-stop = "${
              car.id
            }"disabled>B</button>
            <div class="car" data-id = "${car.id}">
                ${this.darwImage(car.color)}
            </div>
            <div class="flag" data-flag = "${car.id}"></div>
        </div>`;
  }
